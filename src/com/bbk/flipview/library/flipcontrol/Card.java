...
package com.bbk.flipview.library.flipcontrol;
...
import com.bbk.flipview.library.baseutils.TextureUtils;
...
public class Card {
  ...
  public void draw(GL10 gl) {
    ...
    if (angle > 0) {
      ...
      if (axis == AXIS_TOP) {
        if (orientationVertical) {
          h = (cardVertices[Y_00] - cardVertices[Y_01]) * (1.0f - cos(TextureUtils.d2r(angle)));
          z = (cardVertices[Y_00] - cardVertices[Y_01]) * sin(TextureUtils.d2r(angle));
          ...
          w = (cardVertices[X_10] - cardVertices[X_00]) * (1.0f - cos(TextureUtils.d2r(angle)));
          z = (cardVertices[X_10] - cardVertices[X_00]) * sin(TextureUtils.d2r(angle));
          shadowVertices = new float[]{
        ...
        if (orientationVertical) {
          h = (cardVertices[Y_00] - cardVertices[Y_01]) * (1f - cos(TextureUtils.d2r(angle)));
          z = (cardVertices[Y_00] - cardVertices[Y_01]) * sin(TextureUtils.d2r(angle));
          shadowVertices = new float[]{
          ...
          w = (cardVertices[X_10] - cardVertices[X_00]) * (1f - cos(TextureUtils.d2r(angle)));
          z = (cardVertices[X_10] - cardVertices[X_00]) * sin(TextureUtils.d2r(angle));
          shadowVertices = new float[]{
              cardVertices[X_00], cardVertices[Y_00], 0f,
              cardVertices[X_01], cardVertices[Y_01], 0f,
