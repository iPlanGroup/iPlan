...
public class MainActivity extends ActivityGroup implements OnClickListener,
	...
	private String[] subjectArr = { "语文", "数学", "英语", "物理", "化学", "生物", "历史",
			"地理", "生物" };
	...
	public void showAddPlanPop() {
		...
		Button addHolidayBtn = (Button) myView
				.findViewById(R.id.new_holiday_btn);
	...
	public void showAddHWPop() {
		...
		pw.showAtLocation(myView, Gravity.NO_GRAVITY, hwLocationArr[0],
				hwLocationArr[1]);
	...
	public void showPorityDialog(View myView) {
		popPorityBtn = (TextView) myView
				.findViewById(R.id.select_homework_pority_tv);
	...
	public void showSubjectDialog(View myView) {
		popSubjectBtn = (TextView) myView
				.findViewById(R.id.selected_subject_tv);
				...
				new DatePickerDialog(MainActivity.this,
						new OnDateSetListener() {
							public void onDateSet(DatePicker view, int year,
								...
								popDateBtn.setText(year + "-" + monthOfYear
										+ "-" + dayOfMonth);
							}
	...
	class SubjectSpSelectedListener implements OnItemSelectedListener {
		...
		public void onNothingSelected(AdapterView<?> arg0) {
			System.out
					.println("git test two2222222222222222222222222222222222222222");
		}
	}
